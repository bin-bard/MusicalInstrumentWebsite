			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="single-product-content">
						<h3>Dark Brown Classical Violin</h3>
						<p class="single-product-pricing">$85</p>
						<p>The violin is a beautiful string instrument known for its elegance and versatility. It has four strings tuned in perfect fifths and is played using a bow made of wood and horsehair. The body of the violin is traditionally crafted from high-quality woods like spruce and maple, giving it a rich, resonant tone.</p>
						<div class="single-product-form">
							<form action="index.jsp">
								<input type="number" placeholder="0">
							</form>
							<a href="${ctx}/Cart" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
							<p><strong>Categories: </strong>classical violin</p>
						</div>
						<h4>Share:</h4>
