          ...
          <table class="table datanew">
            ...
            <c:forEach var="order" items="${orderList}">
              <tr>
                ...
                <td>
                  <c:choose>
                    <c:when test="${order[4] == 'DELIVERED'}">
                      <span class="badges bg-lightgreen">${order[4]}</span>
                    </c:when>
                    <c:otherwise>
                      <span class="badges bg-lightred">${order[4]}</span>
                    </c:otherwise>
                  </c:choose>
                </td>
                <td><span class="badges bg-lightgreen">${order[5]}</span></td>
                <td>${order[6]}</td>
