						...
						<table class="cart-table">
							...
							<tbody>
								<tr class="table-body-row">
									...
									<td class="product-image"><img src="${ctx}/assets/img/products/product-img-1.jpg" alt=""></td>
									<td class="product-name">Violin</td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="${ctx}/assets/img/products/product-img-2.jpg" alt=""></td>
									<td class="product-name">Guitar</td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="${ctx}/assets/img/products/product-img-3.jpg" alt=""></td>
									<td class="product-name">Piano</td>
									<td class="product-price">$135</td>
									<td class="product-quantity"><input type="number" placeholder="0"></td>
									<td class="product-total">1</td>
								</tr>
							</tbody>
