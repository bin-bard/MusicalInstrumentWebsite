				...
				<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							...
							<div class="hero-btns">
								<a href="${ctx}/Shop" class="boxed-btn">Instrument Collection</a>
				...
				<div class="col-lg-10 offset-lg-1 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							...
							<div class="hero-btns">
								<a href="${ctx}/Shop" class="boxed-btn">Visit Shop</a>
								<a href="${ctx}/WEB-INF/views/contact.html" class="bordered-btn">Contact Us</a>
							</div>
						</div>
					</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="${ctx}/SingleProduct"><img src="${ctx}/assets/img/products/product-img-1.jpg" alt=""></a>
					</div>
					<h3>Violin</h3>
			...
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="${ctx}/SingleProduct"><img src="${ctx}/assets/img/products/product-img-2.jpg" alt=""></a>
					</div>
					<h3>Guitar</h3>
			...
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="${ctx}/SingleProduct"><img src="${ctx}/assets/img/products/product-img-3.jpg" alt=""></a>
					</div>
					<h3>Piano</h3>
		...
		<div class="row clearfix">
			...
			<div class="image-column col-lg-6">
				<div class="image">
					...
					<img src="${ctx}/assets/img/products/acoustic.jpg" alt="">
				</div>
			</div>
			<!--Content Column-->
			<div class="content-column col-lg-6">
				...
				<a href="${ctx}/Cart" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
			</div>
		</div>
	</div>
</section>
...
<section class="shop-banner">
	<div class="container">
		...
		<a href="${ctx}/Shop" class="cart-btn btn-lg">Shop Now</a>
	</div>
</section>
<!-- end shop banner -->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-latest-news">
					<a href="${ctx}/SingleNews"><div class="latest-news-bg news-bg-1"></div></a>
					<div class="news-text-box">
						<h3><a href="${ctx}/SingleNews">You will vainly look for fruit on it in autumn.</a></h3>
						<p class="blog-meta">
							<span class="author"><i class="fas fa-user"></i> Admin</span>
							<span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
						</p>
						<p class="excerpt">Vivamus lacus enim, pulvinar vel nulla sed, scelerisque rhoncus nisi. Praesent vitae mattis nunc, egestas viverra eros.</p>
						<a href="${ctx}/SingleNews" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="single-latest-news">
					<a href="${ctx}/SingleNews"><div class="latest-news-bg news-bg-2"></div></a>
					<div class="news-text-box">
						<h3><a href="${ctx}/SingleNews">A man's worth has its season, like tomato.</a></h3>
						<p class="blog-meta">
							<span class="author"><i class="fas fa-user"></i> Admin</span>
							<span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
						</p>
			...
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
				<div class="single-latest-news">
					<a href="${ctx}/SingleNews"><div class="latest-news-bg news-bg-3"></div></a>
					<div class="news-text-box">
						<h3><a href="${ctx}/SingleNews">Good thoughts bear good fresh juicy fruit.</a></h3>
						<p class="blog-meta">
							<span class="author"><i class="fas fa-user"></i> Admin</span>
							<span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
						</p>
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<a href="${ctx}/SingleNews" class="boxed-btn">More News</a>
			</div>
		</div>
	</div>
</div>
...
<!-- isotope -->
<script src="${ctx}/assets/js/jquery.isotope-3.0.6.min.js"></script>
<!-- waypoints -->
<script src="${ctx}/assets/js/waypoints.js"></script>
<!-- owl carousel -->
<script src="${ctx}/assets/js/owl.carousel.min.js"></script>
<!-- magnific popup -->
<script src="${ctx}/assets/js/jquery.magnific-popup.min.js"></script>
<!-- mean menu -->
<script src="${ctx}/assets/js/jquery.meanmenu.min.js"></script>
<!-- sticker js -->
